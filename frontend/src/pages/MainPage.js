        ...
        <div style={pageStyle}>
            ...
            {cases.slice(0, 3).map((c, index) => (
                <div key={c.id} style={boxStyle}>
                    ...
                    <p style={textStyle}>
                        <span style={boldStyle}>Q1:</span> On a scale of 1-10, how well do you understand this statement?<br />
            ...
            <div style={boxStyle}>
                <p style={textStyle}>
                    <span style={boldStyle}>Special Question :</span> This is a special question not related to any case.<br />
                    <span style={italicStyle}>
                            (Set the slider to position 7)
                        </span>
                </p>
                <div style={sliderContainerStyle}>
                    <input 
            ...
            <div style={boxStyle}>
                <div>
                    <p style={textStyle}>
                        <span style={boldStyle}>Task :</span> Rewrite the last case (Case 5) in your own words.<br />
                        <span style={italicStyle}>
